...
class Model {
    ...
    public function fetchById($id){
      return $this->db->fetchOne($this->viewTableName, $this->viewFields, 
              $this->primaryKey, '=', $id, '', '1');
    }
    ...
    public function update($values, $fields = '', $filterFields = '',
        ...
        if ($isValid === true) {
            ...
            return $this->db->editRecords($this->changeTableName, $fields,
                 $filterFields, $filterOps, $filterValues, '', $values);
        }
        return $isValid;
    }
    ...
    public function delete($id){
        return $this->db->deleteRecords($this->changeTableName, 
                $this->primaryKey, '=', $id, '1');
    }
